  ...
  return (
    <div>
      <PageHeader
        ...
        action={
          <Link href="/pagos/proveedores/nuevo">
      ...
      {pagos.length === 0 ? (
        <EmptyState
          ...
          description="Registra el primer pago a un proveedor"
          action={
            <Link href="/pagos/proveedores/nuevo">
            ...
            <TableBody>
              {pagos.map((p) => (
                <TableRow key={p.id} className="hover:bg-neutral-50">
                  ...
                  <TableCell>
                    <div>
                      <p className="font-medium text-sm">{p.proveedor.nombre}</p>
                      {p.proveedor.servicio && <p className="text-xs text-neutral-400">{p.proveedor.servicio}</p>}
                    </div>
                  </TableCell>
